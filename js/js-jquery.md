...
⚠️ **WARNING**
> Pour l'utilisation de `animate`, c'est seulement les propriétés qui ont une valeur numérique. On ne peut pas mettre `margin: 30px` (seulement le chiffre) ou `color: 'orange'`.
